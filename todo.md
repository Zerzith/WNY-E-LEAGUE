...
## New Requests - ครั้งที่ 4
- [x] ดึงโลโก้และชื่อทีมจากการลงทะเบียน (registrations) ทุกหน้า
- [x] แสดงทีมที่อนุมัติแล้วและคำขอทีมที่สมัครคู่กุนไว้ ในหน้าเดียวกัน
- [x] เพิ่ม Modal สำหรับแสดงรายชื่อสมาชิก เมื่อคลิกโลโก้ทีม
- [x] ใช้ได้ทุกหน้า: EventDetail, HallOfFame, Admin Dashboard, MatchManagement
